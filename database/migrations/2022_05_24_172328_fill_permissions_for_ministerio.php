...
class FillPermissionsForMinisterio extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMinisterio constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ministerio',
            'admin.ministerio.index',
            'admin.ministerio.create',
            'admin.ministerio.show',
            'admin.ministerio.edit',
            'admin.ministerio.delete',
            'admin.ministerio.bulk-delete',
        ]);
